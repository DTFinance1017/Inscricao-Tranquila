...
export default function Home() {
  ...
  const NavLinks = () => (
    <>
      ...
      <Button 
        ...
        className="bg-brand-yellow text-brand-navy hover:bg-brand-yellow/90 font-display font-bold rounded-none uppercase text-xs tracking-wider"
      >
        Inscrição
      </Button>
    </>
      ...
      <div className="min-h-[100dvh] bg-brand-navy flex flex-col items-center justify-center p-6 animate-in fade-in duration-700">
        <div className="max-w-md w-full text-center space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-5xl font-display font-black uppercase text-white leading-none">
            ...
            <div className="inline-block mt-2 font-display font-bold text-sm tracking-[0.15em] bg-brand-yellow text-brand-navy px-4 py-1 uppercase">
              Sua inscrição só será analisada após o envio.
            </div>
            
            <div className="font-display font-black text-2xl text-white tracking-[0.08em] my-6 border-y border-white/10 py-4">
              (19) 99417-3926
            </div>
          </div>
          ...
          <div className="space-y-4 pt-4 relative">
            {waLink && (
              <div className="relative">
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-white text-brand-navy font-display font-bold text-[10px] tracking-widest px-3 py-1 uppercase z-10 whitespace-nowrap shadow-lg">
                  PASSO FINAL OBRIGATÓRIO
                </div>
                <Button 
                  className="w-full bg-[#25D366] hover:bg-[#20bd5a] text-white h-16 font-display font-bold tracking-widest text-[14px] rounded-none group hover:scale-[1.02] transition-transform shadow-2xl" 
                  size="lg"
            ...
            {waMessage && (
              <div className="space-y-2 mt-6">
                <Button
                  className="w-full text-white h-14 font-display font-bold tracking-widest text-[13px] rounded-none shadow-lg group hover:scale-[1.02] transition-transform"
            ...
            <Button 
              className="w-full mt-6 bg-transparent hover:bg-white/10 text-white h-14 font-display font-bold border border-white/20 rounded-none tracking-widest" 
              size="lg"
  ...
  return (
    <div className="bg-brand-navy min-h-screen text-white font-sans overflow-x-hidden selection:bg-brand-yellow selection:text-brand-navy">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-brand-navy/95 backdrop-blur-md shadow-xl py-3' : 'bg-transparent py-5'}`}>
        <div className="container mx-auto px-6 flex items-center justify-between">
          <img src={logoRacemanWhite} alt="Raceman Kart" className="h-10 cursor-pointer" onClick={() => window.scrollTo(0,0)} />
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="font-display font-bold tracking-[0.3em] text-brand-yellow text-sm uppercase">Campeonato Oficial</span>
            </div>
            
            <h1 className="font-display font-black text-6xl lg:text-8xl leading-[0.9] uppercase tracking-tight mb-8">
              Copa<br/>Raceman<br/>Kart <span className="text-brand-yellow">2027</span>
            </h1>

            <p className="text-xl lg:text-2xl font-display font-medium tracking-wide text-[#8FAED5] leading-relaxed mb-10 max-w-xl">
              MESMO MOTOR.<br/>
              MESMA CHANCE.<br/>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                onClick={() => scrollTo('inscricao')}
                className="bg-brand-yellow hover:bg-brand-yellow/90 text-brand-navy h-14 px-8 rounded-none font-display font-bold text-sm tracking-widest uppercase transition-transform hover:scale-[1.02]"
              >
              ...
              <Button 
                ...
                variant="outline"
                className="bg-transparent border-white/30 text-white hover:bg-white/10 h-14 px-8 rounded-none font-display font-bold text-sm tracking-widest uppercase"
              >
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-16">
            <div className="flex items-center gap-3 mb-4">
              <span className="font-display font-black text-brand-blue/20 text-2xl">01</span>
              <h2 className="font-display font-bold tracking-[0.2em] text-brand-blue uppercase text-sm">O Campeonato</h2>
            </div>
            <h3 className="font-display font-black text-5xl lg:text-6xl leading-[0.9] uppercase tracking-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-[#F8FAFC] border border-[#E1E7EF] border-t-4 border-t-brand-blue p-8 relative overflow-hidden group hover:shadow-lg transition-shadow">
              ...
              <div className="font-display font-black text-4xl mb-2">11</div>
              <div className="font-display font-bold text-xs tracking-widest text-brand-graphite/60 uppercase">Etapas Oficiais & Treinos</div>
            </div>
            ...
            <div className="bg-[#F8FAFC] border border-[#E1E7EF] border-t-4 border-t-brand-yellow p-8 relative overflow-hidden group hover:shadow-lg transition-shadow">
              ...
              <div className="font-display font-black text-4xl mb-2">18<span className="text-xl">HP</span></div>
              <div className="font-display font-bold text-xs tracking-widest text-brand-graphite/60 uppercase">Motor Honda RBC</div>
            </div>

            <div className="bg-[#F8FAFC] border border-[#E1E7EF] border-t-4 border-t-brand-blue p-8 relative overflow-hidden group hover:shadow-lg transition-shadow">
              <Calendar className="w-8 h-8 text-brand-blue mb-6" />
              <div className="font-display font-black text-4xl mb-2">2<span className="text-xl">×</span></div>
              <div className="font-display font-bold text-xs tracking-widest text-brand-graphite/60 uppercase">Equalizações por ano</div>
            </div>
            ...
            <div className="bg-brand-navy text-white border-t-4 border-t-brand-graphite p-8 relative overflow-hidden group hover:shadow-lg transition-shadow">
              ...
              <div className="font-display font-black text-4xl mb-2">3 <span className="text-lg">Etapas</span></div>
              <div className="font-display font-bold text-xs tracking-widest text-[#8FAED5] uppercase mb-2">Troca de pneus</div>
              <div className="text-[10px] font-bold tracking-wider text-brand-yellow uppercase">Custo do Piloto</div>
            </div>
          </div>
          
          <div className="mt-12 text-center">
             <Button onClick={() => scrollTo('inscricao')} className="bg-brand-yellow text-brand-navy hover:bg-brand-yellow/90 h-12 px-8 rounded-none font-display font-bold text-xs tracking-widest uppercase">
                Garantir Minha Vaga
              </Button>
          </div>
        </div>
      ...
      <section id="investimento" className="py-24 bg-[#F8FAFC] text-brand-navy border-t border-[#E1E7EF]">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-16">
            <div className="flex items-center gap-3 mb-4">
              <span className="font-display font-black text-brand-blue/20 text-2xl">02</span>
              <h2 className="font-display font-bold tracking-[0.2em] text-brand-blue uppercase text-sm">Investimento</h2>
            </div>
            <h3 className="font-display font-black text-5xl lg:text-6xl leading-[0.9] uppercase tracking-tight">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-brand-navy text-white p-8 lg:p-12 relative shadow-xl">
              ...
              <h4 className="font-display font-bold tracking-[0.2em] text-brand-yellow text-xs uppercase mb-6">Aluguel do Motor Oficial 2027</h4>
              <div className="flex items-baseline gap-2 mb-4">
                <span className="font-display font-black text-5xl">R$ 3.000</span>
                <span className="text-[#8FAED5] font-bold">,00 à vista</span>
              </div>
              <div className="bg-white/10 inline-block px-4 py-2 font-display font-bold tracking-wide text-sm mb-6">
            ...
            <div className="bg-white border border-[#E1E7EF] p-8 lg:p-12 shadow-xl">
              <h4 className="font-display font-bold tracking-[0.2em] text-brand-blue text-xs uppercase mb-6">Custo do Campeonato</h4>
              <div className="flex items-baseline gap-2 mb-4">
                <span className="font-display font-black text-5xl text-brand-navy">R$ 11.000</span>
                <span className="text-brand-graphite/60 font-bold">,00 à vista</span>
              </div>
              <div className="bg-[#F8FAFC] border border-[#E1E7EF] inline-block px-4 py-2 font-display font-bold tracking-wide text-brand-navy text-sm mb-6">
          ...
          <div className="bg-white border border-[#E1E7EF] p-8 lg:p-12 mb-8">
            <h4 className="font-display font-bold tracking-[0.2em] text-brand-blue text-sm uppercase mb-8">O que está incluso</h4>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-[#1C1C1C] text-white p-8">
              <h4 className="font-display font-bold tracking-[0.2em] text-brand-yellow text-xs uppercase mb-6">O que o piloto precisa ter</h4>
              <div className="space-y-4">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                  <div className="w-2 h-2 bg-brand-yellow rounded-full"></div>
                  <span className="font-display font-bold tracking-wide uppercase text-sm">Chassi próprio, de qualquer marca</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-brand-yellow rounded-full"></div>
                  <span className="font-display font-bold tracking-wide uppercase text-sm">Dois jogos de rodas</span>
                </div>
              </div>
            </div>
      ...
      <section id="premiacao" className="py-24 bg-brand-navy relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl mb-16">
            <div className="flex items-center gap-3 mb-4">
              <span className="font-display font-black text-brand-blue text-2xl">03</span>
              <h2 className="font-display font-bold tracking-[0.2em] text-brand-yellow uppercase text-sm">Premiação</h2>
            </div>
            <h3 className="font-display font-black text-5xl lg:text-6xl leading-[0.9] uppercase tracking-tight">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-5 bg-white text-brand-navy p-8 lg:p-12">
              ...
              <div className="font-display font-black text-6xl mb-2">TOP <span className="text-brand-yellow">5</span></div>
              ...
              <div className="mt-12 bg-brand-navy p-6">
                <div className="font-display font-black text-xl text-white uppercase leading-tight mb-2">
            ...
            <div className="lg:col-span-7 space-y-8">
              <div className="bg-[#15345C] border border-[#1B4278] p-8">
                <h4 className="font-display font-bold tracking-[0.2em] text-brand-yellow text-xs uppercase mb-6">Voucher Restaurante Pobre Juan (Por Etapa)</h4>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-brand-navy p-6 flex flex-col justify-center border-l-4 border-brand-yellow">
                    <div className="font-display font-black text-4xl text-white mb-2">R$ 500</div>
                    <div className="font-display font-bold text-[10px] tracking-widest text-[#8FAED5] uppercase">Vencedor Categoria Ouro</div>
                  </div>
                  <div className="bg-brand-navy p-6 flex flex-col justify-center border-l-4 border-gray-400">
                    <div className="font-display font-black text-4xl text-white mb-2">R$ 300</div>
                    <div className="font-display font-bold text-[10px] tracking-widest text-[#8FAED5] uppercase">Vencedor Categoria Prata</div>
                  </div>
                </div>
              </div>

              <div className="bg-[#15345C] border border-[#1B4278] p-8">
                <h4 className="font-display font-bold tracking-[0.2em] text-[#8FAED5] text-xs uppercase mb-6">Vantagens dos Patrocinadores</h4>
                <div className="space-y-4">
      ...
      <section id="kartodromos" className="py-24 bg-white text-brand-navy border-t-8 border-brand-yellow">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-16">
            <div className="flex items-center gap-3 mb-4">
              <span className="font-display font-black text-brand-blue/20 text-2xl">04</span>
              <h2 className="font-display font-bold tracking-[0.2em] text-brand-blue uppercase text-sm">Kartódromos da Temporada</h2>
            </div>
            <h3 className="font-display font-black text-5xl lg:text-6xl leading-[0.9] uppercase tracking-tight">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-brand-navy text-white p-10 lg:p-14 flex flex-col justify-end min-h-[400px] relative overflow-hidden group">
              ...
              <div className="relative z-20">
                <div className="inline-block bg-brand-yellow text-brand-navy font-display font-bold text-xs tracking-widest uppercase px-3 py-1 mb-4">
                  Sede Principal
                </div>
                <h4 className="font-display font-black text-4xl lg:text-5xl uppercase leading-none mb-4">
            ...
            <div className="flex flex-col gap-4">
              <h5 className="font-display font-bold tracking-[0.2em] text-brand-graphite/50 text-xs uppercase mb-2">Etapas Itinerantes</h5>
              ...
              <div className="grid grid-cols-2 gap-4 flex-1">
                {[
                  ...
                  <div key={i} className="bg-[#F8FAFC] border border-[#E1E7EF] p-6 flex flex-col justify-center hover:border-brand-blue transition-colors">
                    ...
                    <div className="font-display font-black text-xl uppercase leading-none mb-1 text-brand-navy">{p.name}</div>
                    <div className="font-display font-bold text-[9px] tracking-widest text-brand-graphite/50">{p.city}</div>
                  </div>
                ))}
                ...
                <div className="col-span-2 bg-[#F8FAFC] border border-[#E1E7EF] p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:border-brand-blue transition-colors relative overflow-hidden">
                  ...
                  <div>
                    <div className="font-display font-black text-xl uppercase leading-none mb-1 text-brand-navy">Interlagos</div>
                    <div className="font-display font-bold text-[9px] tracking-widest text-brand-graphite/50">SÃO PAULO · SP</div>
                  </div>
                  <div className="bg-brand-yellow text-brand-navy font-display font-bold text-[9px] tracking-widest px-3 py-1 uppercase self-start sm:self-auto">
                    Potencial Novidade
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <div className="flex items-center justify-center gap-3 mb-4">
                <span className="font-display font-black text-brand-blue/20 text-2xl">05</span>
                <h2 className="font-display font-bold tracking-[0.2em] text-brand-blue uppercase text-sm">Solicitação de Vaga</h2>
              </div>
              <h3 className="font-display font-black text-5xl lg:text-6xl leading-[0.9] uppercase tracking-tight text-brand-navy mb-6">
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-brand-navy font-display font-bold text-xs tracking-widest uppercase">Nome Completo *</FormLabel>
                          <FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-brand-navy font-display font-bold text-xs tracking-widest uppercase">WhatsApp (com DDD) *</FormLabel>
                          <FormControl>
                            <Input 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-brand-navy font-display font-bold text-xs tracking-widest uppercase">E-mail</FormLabel>
                          <FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-brand-navy font-display font-bold text-xs tracking-widest uppercase">Cidade</FormLabel>
                          <FormControl>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-brand-navy font-display font-bold text-xs tracking-widest uppercase">Ano de Nasc.</FormLabel>
                          <FormControl>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-brand-navy font-display font-bold text-xs tracking-widest uppercase">Experiência *</FormLabel>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-brand-navy font-display font-bold text-xs tracking-widest uppercase">Observações (Opcional)</FormLabel>
                        <FormControl>
                          <Textarea 
                  ...
                  <Button 
                    type="submit" 
                    size="lg" 
                    className="w-full h-16 mt-8 group bg-brand-navy hover:bg-[#041226] text-white font-display font-bold tracking-widest rounded-none text-sm uppercase transition-all"
      ...
      <section id="patrocinadores" className="py-24 bg-brand-navy border-t-8 border-[#15345C]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-3 mb-4">
              <span className="font-display font-black text-brand-blue text-2xl">06</span>
              <h2 className="font-display font-bold tracking-[0.2em] text-brand-yellow uppercase text-sm">Apoio Oficial</h2>
            </div>
            <h3 className="font-display font-black text-4xl lg:text-5xl uppercase tracking-tight text-white">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="pt-12 border-t border-white/10">
              <div className="font-display font-bold text-xs tracking-[0.3em] text-[#8FAED5] mb-8 text-center uppercase">Demais Patrocinadores</div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={i} className="bg-white h-24 flex flex-col items-center justify-center p-4 hover:scale-105 transition-transform cursor-default">
                    ...
                    {s.extra && <div className="font-display font-bold text-[8px] tracking-widest text-brand-graphite/40 mt-2 uppercase">{s.extra}</div>}
                  </div>
                ))}
                ...
                <div className="bg-[#15345C] border border-dashed border-[#8FAED5]/30 h-24 flex items-center justify-center p-4 group cursor-pointer hover:bg-[#1A4070] transition-colors">
                  <span className="font-display font-bold text-[10px] tracking-widest text-[#8FAED5] uppercase group-hover:text-brand-yellow transition-colors">SEU LOGO AQUI</span>
                </div>
                <div className="bg-[#15345C] border border-dashed border-[#8FAED5]/30 h-24 flex items-center justify-center p-4 group cursor-pointer hover:bg-[#1A4070] transition-colors">
                  <span className="font-display font-bold text-[10px] tracking-widest text-[#8FAED5] uppercase group-hover:text-brand-yellow transition-colors">SEU LOGO AQUI</span>
                </div>
              ...
              <div className="mt-12 text-center bg-[#15345C] p-8 border border-white/5">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-brand-yellow text-brand-navy font-display font-bold text-sm tracking-widest px-8 py-4 uppercase hover:scale-[1.02] transition-transform rounded-none"
                >
      ...
      <footer className="bg-[#041226] py-16 border-t border-white/5">
        <div className="container mx-auto px-6 flex flex-col items-center text-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center font-display font-black text-xl text-white px-8 py-4 mb-12 hover:scale-[1.03] transition-transform rounded-none shadow-lg"
            style={{ background: "linear-gradient(45deg,#F58529,#DD2A7B,#8134AF,#515BD4)" }}
          >
            @racemankart
          </a>
      ...
      <div className={`lg:hidden fixed bottom-0 left-0 right-0 p-4 pb-[max(1rem,env(safe-area-inset-bottom))] bg-brand-navy/90 backdrop-blur-md border-t border-white/10 z-40 transition-transform duration-300 ${showBottomCTA ? 'translate-y-0' : 'translate-y-full'}`}>
        <Button 
          onClick={() => scrollTo('inscricao')}
          className="w-full bg-brand-yellow hover:bg-brand-yellow/90 text-brand-navy h-14 rounded-none font-display font-bold text-sm tracking-widest uppercase shadow-2xl"
        >
          GARANTIR MINHA VAGA
        </Button>
      </div>
